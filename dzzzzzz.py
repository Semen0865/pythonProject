...
for day in range(1,800):
    if nick.live(day) == False:
        ...
        class Human:
            ...
            def introduce(self):
                return f"Привіт, мене звати {self.name}. Мені {self.age} років, і я {self.gender}."

            def greet(self, other_person):
                return f"Привіт, {other_person.name}! Я {self.name}."


        # Приклад використання
        person1 = Human("Олена", 12, "жіноча")
        person2 = Human("Іван", 13, "чоловіча")

        print(person1.introduce())
        print(person2.introduce())

        print(person1.greet(person2))
        print(person2.greet(person1))